...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($result) {
            $success = 'تم تحديث البيانات بنجاح، سيتم تحويلك للملف الشخصي...';
...
<body class="bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen ">
    <div class="max-w-[60%] mx-auto my-8  px-4">
        <div class="bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center text-center">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">تعديل الملف الشخصي</h2>
            <?php if ($success): ?>
            ...
            <form method="POST" class="w-full space-y-4 text-right">
                <div>
                    ...
                    <input type="text" id="name" name="name" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="أدخل اسمك الكامل" value="<?php echo htmlspecialchars($name ?? ''); ?>">
                ...
                <div>
                    ...
                    <input type="text" id="email_or_phone" name="email_or_phone" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="أدخل بريدك الإلكتروني أو رقم هاتفك" value="<?php echo htmlspecialchars($email ?: $phone); ?>">
