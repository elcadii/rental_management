    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-blue-100 max-w-2xl mx-auto">
                مرحباً بك في لوحة تحكم نظام إدارة الإيجارات
            </p>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border-r-4 border-blue-500">
                            ...
                            <div>
                                <div class="text-sm text-blue-600 font-medium">البريد الإلكتروني</div>
                                <div class="text-lg font-semibold text-gray-900">
                                    <?php echo $email ? htmlspecialchars($email) : '<span class="text-gray-400">غير محدد</span>'; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border-r-4 border-purple-500">
                            ...
                            <div>
                                <div class="text-sm text-purple-600 font-medium">رقم الهاتف</div>
                                <div class="text-lg font-semibold text-gray-900">
                                    <?php echo $phone ? htmlspecialchars($phone) : '<span class="text-gray-400">غير محدد</span>'; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border-r-4 border-green-500">
                            ...
                            <div>
                                <div class="text-sm text-green-600 font-medium">تاريخ الانضمام</div>
                                <div class="text-lg font-semibold text-gray-900">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div class="stat-card rounded-2xl p-6 text-center group">
                ...
                <div class="text-gray-600 font-medium">إجمالي المستأجرين</div>
            ...
            <div class="stat-card rounded-2xl p-6 text-center group">
                ...
                <div class="text-gray-600 font-medium">أنواع السكن</div>
            ...
            <div class="stat-card rounded-2xl p-6 text-center group">
                ...
                <div class="text-gray-600 font-medium">العقود النشطة</div>
            ...
            <div class="stat-card rounded-2xl p-6 text-center group">
                ...
                <div class="text-gray-600 font-medium">العقود المنتهية</div>
        ...
        <div class="glass-effect rounded-3xl shadow-2xl p-8 text-center mb-12">
            <div class="max-w-2xl mx-auto">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-4">ملخص الإيرادات</h2>
        ...
        <div class="glass-effect rounded-3xl shadow-2xl p-8 mb-12">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold gradient-text mb-4">
                    ...
                    تقارير مالية شاملة ومفصلة لمتابعة أداء استثماراتك
                </h2>
                <p class="text-gray-600 text-lg">متابعة أداء استثماراتك وتحليل البيانات المالية</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-sm text-emerald-600 font-medium">متوسط الإيجار اليومي</div>
                            <div class="text-2xl font-bold text-emerald-800">
                                <?php echo number_format($avg_daily_rent, 2); ?>
                            </div>
                            <div class="text-xs text-emerald-600"><?php echo $current_currency['symbol']; ?>/يوم</div>
                        </div>
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-sm text-blue-600 font-medium">معدل الإشغال</div>
                            <div class="text-2xl font-bold text-blue-800"><?php echo $occupancy_rate; ?>%</div>
                            <div class="text-xs text-blue-600">من الوحدات مشغولة</div>
                        </div>
                ...
                <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-sm text-purple-600 font-medium">إجمالي المستأجرين</div>
                            <div class="text-2xl font-bold text-purple-800"><?php echo number_format($total_tenants); ?></div>
                            <div class="text-xs text-purple-600">مستأجر نشط</div>
                        </div>
            ...
            <div class="bg-white rounded-2xl p-6 mb-8 border border-gray-200">
                <h3 class="text-xl font-bold text-gray-900 mb-4 flex items-center">
                    ...
                    الإيرادات الشهرية (آخر 6 أشهر) - <?php echo $current_currency['symbol']; ?> <?php echo $current_currency['code']; ?>
                </h3>
            ...
            <div class="bg-white rounded-2xl p-6 mb-8 border border-gray-200">
                <h3 class="text-xl font-bold text-gray-900 mb-4 flex items-center">
                    ...
                    الإيرادات حسب نوع السكن - <?php echo $current_currency['symbol']; ?> <?php echo $current_currency['code']; ?>
                </h3>
                <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-600"><?php echo $type['tenant_count']; ?> مستأجر</div>
                                </div>
                            </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-green-700 font-medium">عقود نشطة</span>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-red-700 font-medium">عقود منتهية</span>
                            </div>
